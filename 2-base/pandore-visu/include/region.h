 ...
 */
   class Reg2d: public Img2d<Long> {
	  ...
	  * @param p	the properties of the map.
	  */
	 void New(const PobjectProps& p) { New(p.nrow,p.ncol); nlabels=p.nlabels; }
	  ...
	  * @return	the region map itself.
	  */
	 Reg2d& operator=(const Reg2d &reg);
 ...
 */
   class Reg3d: public Img3d<Long> {
	  ...
	  * @param p	the properties of the map.
	  */
	 void New( const PobjectProps& p ) { New(p.ndep,p.nrow,p.ncol);nlabels=p.nlabels; }
	  ...
	  * @return	the region map itself.
	  */
	 Reg3d& operator=( const Reg3d &reg );
