...
public :
    ...
    */
   operator Char() { return _val.v_Char; }
   /*
    * Converts the value to a Uchar value.
    * @return	the related value.
    */
   operator Uchar() { return _val.v_Uchar; }
   /*
    * Converts the value to a Short value.
    * @return	the related value.
    */
   operator Short() { return _val.v_Short; }
   /*
    * Converts the value to a Ushort value.
    * @return	the related value.
    */
   operator Ushort() { return _val.v_Ushort; }
   /*
    * Converts the value to a Long value.
    * @return	the related value.
    */
   operator Long() { return _val.v_Long; }
   /*
    * Converts the value to a Ulong value.
    * @return	the related value.
    */
   operator Ulong() { return _val.v_Ulong; }
   /*
    * Converts the value to a Float value.
    * @return	the related value.
    */
   operator Float() { return _val.v_Float; }
   /*
    * Converts the value to a Double value.
    * @return	the related value.
    */
   operator Double() { return _val.v_Double; }
